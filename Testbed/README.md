...
SQS step by step guide, extracted from https://github.com/International-Data-Spaces-Association/IDS-testbed/blob/master/Testbed/Aitor_DAPS.md
...
If everything is setup correctly, a Dynamic Attribute Token (DAT) is received with a specific expiration date.
